...
\end{flushright}
\noindent{\LARGE\bfseries\scshape Alvin Zhou} \hfill \footnotesize Updated: July 2020
\bigskip
\hrule
\normalsize
...
\years{[8]} Men, R. L., Tsai, W.H. S., \& Zhou, A. (In Preparation). \textit{Chatbots in Relationship Building.}\\
...
%\years{[13]} Zhou, A. (2020). \textit{Causal Effects of Affordance Change on Communication Behavior}. Association for Education in Journalism and Mass Communication (Communication Technology Division), San Francisco, CA.\\
...
%  \years{2021-} Student and Early Career Representative, Public Relations Division, ICA\\
